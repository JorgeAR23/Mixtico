...
public class FamiliaP4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_familia_p4);
    ...
    public void Respuesta(View view) {
        if(rb1.isChecked()) {
            ...
            editor.putInt("aciertoFamilia4", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoFamilia4", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::P5, 2000);
    ...
    public void P5(){
        Intent p5 = new Intent(this, FamiliaP5.class);
        startActivity(p5);
    }
