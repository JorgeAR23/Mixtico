...
public class ColoresP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colores_p2);
    ...
    public void p3(){
        Intent p3 = new Intent(this, ColoresP3.class);
        startActivity(p3);
    }
