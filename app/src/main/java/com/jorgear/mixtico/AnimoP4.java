...
public class AnimoP4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animo_p4);
    ...
    public void P5(){
        Intent p5 = new Intent(this, AnimoP5.class);
        startActivity(p5);
    }
