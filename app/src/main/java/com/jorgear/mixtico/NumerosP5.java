...
public class NumerosP5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numeros_p5);
    ...
    public void Respuesta(View view) {
        if(rb4.isChecked()) {
            ...
            editor.putInt("aciertoNumero5", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoNumero5", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::Salir, 2000);
