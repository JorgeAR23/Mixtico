...
public class CuerpoP3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuerpo_p3);
        ...
        vozPregunta = MediaPlayer.create(this, R.raw.vcabeza);
    ...
    public void Respuesta(View view) {
        if(rb1.isChecked()) {
            ...
            editor.putInt("aciertoCuerpo3", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoCuerpo3", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::P4, 2000);
    ...
    public void P4(){
        Intent p4 = new Intent(this, CuerpoP4.class);
        startActivity(p4);
    }
