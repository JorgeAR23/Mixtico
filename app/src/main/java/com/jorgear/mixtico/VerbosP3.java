...
public class VerbosP3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbos_p3);
    ...
    public void P4(){
        Intent p4 = new Intent(this, VerbosP4.class);
        startActivity(p4);
    }
