...
public class FamiliaP1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_familia_p1);
    ...
    public void Respuesta(View view) {
        if(rb3.isChecked()) {
            ...
            editor.putInt("aciertoFamilia1", 1);
            editor.apply();
            ...
            //Manda el dato al MainActivity
            editor.putInt("aciertoFamilia1", 0);
            editor.apply();
    ...
    public void P2(){
        Intent p2 = new Intent(this, FamiliaP2.class);
        startActivity(p2);
    }
