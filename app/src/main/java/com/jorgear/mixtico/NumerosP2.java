...
public class NumerosP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numeros_p2);
    ...
    public void Respuesta(View view) {
        if(rb1.isChecked()) {
            ...
            editor.putInt("aciertoNumero2", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoNumero2", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::P3, 2000);
    ...
    public void P3(){
        Intent p3 = new Intent(this, NumerosP3.class);
        startActivity(p3);
    }
