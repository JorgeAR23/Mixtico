...
public class SustantivosP4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sustantivos_p4);
    ...
    public void Respuesta(View view) {
        if(rb1.isChecked()) {
            ...
            editor.putInt("aciertoSustantivo4", 1);
            editor.apply();
    ...
    public void P5(){
        Intent p5 = new Intent(this, SustantivosP5.class);
        startActivity(p5);
    }
