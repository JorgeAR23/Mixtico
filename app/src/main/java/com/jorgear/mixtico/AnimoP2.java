...
public class AnimoP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animo_p2);
    ...
    public void P3(){
        Intent p3 = new Intent(this, AnimoP3.class);
        startActivity(p3);
    }
