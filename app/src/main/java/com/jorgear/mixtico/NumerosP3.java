...
public class NumerosP3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numeros_p3);
    ...
    public void Respuesta(View view) {
        if(rb1.isChecked()) {
            ...
            editor.putInt("aciertoNumero3", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoNumero3", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::P4, 2000);
    ...
    public void P4(){
        Intent p4 = new Intent(this, NumerosP4.class);
        startActivity(p4);
    }
