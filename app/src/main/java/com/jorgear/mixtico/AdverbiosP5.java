...
public class AdverbiosP5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adverbios_p5);
    ...
    public void Respuesta(View view) {
        if(rb4.isChecked()) {
            ...
            editor.putInt("aciertoAdverbio5", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoAdverbio5", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::Salir, 2000);
