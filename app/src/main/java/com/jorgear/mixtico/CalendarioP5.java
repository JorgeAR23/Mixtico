...
public class CalendarioP5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendario_p5);
    ...
    public void Respuesta(View view) {
        if(rb4.isChecked()) {
            ...
            editor.putInt("aciertoCalendario5", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoCalendario5", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::Salir, 2000);
