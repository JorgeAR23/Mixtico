...
public class AnimalesP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animales_p2);
    ...
    public void Respuesta(View view) {
        if(rb3.isChecked()) {
            ...
            editor.putInt("aciertoAnimal2", 1);
            editor.apply();
            ...
            //Manda el dato al MainActivity
            editor.putInt("aciertoAnimal2", 0);
            editor.apply();
    ...
    public void P3(){
        Intent p3 = new Intent(this, AnimalesP3.class);
        startActivity(p3);
    }
