...
public class CuerpoP1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuerpo_p1);
    ...
    public void Respuesta(View view) {
        if(rb3.isChecked()) {
            ...
            editor.putInt("aciertoCuerpo1", 1);
            editor.apply();
            ...
            //Manda el dato al MainActivity
            editor.putInt("aciertoCuerpo1", 0);
            editor.apply();
    ...
    public void P2(){
        Intent p2 = new Intent(this, CuerpoP2.class);
        startActivity(p2);
    }
