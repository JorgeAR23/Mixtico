...
public class NumerosP1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numeros_p1);
    ...
    public void Respuesta(View view) {
        if(rb3.isChecked()) {
            ...
            editor.putInt("aciertoNumero1", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoNumero1", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::P2, 2000);
    ...
    public void P2(){
        Intent p2 = new Intent(this, NumerosP2.class);
        startActivity(p2);
    }
