...
public class VerbosP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbos_p2);
    ...
    public void P3(){
        Intent p3 = new Intent(this, VerbosP3.class);
        startActivity(p3);
    }
