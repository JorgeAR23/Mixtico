...
public class AlimentosP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alimentos_p2);
    ...
    public void Respuesta(View view) {
        if(rb3.isChecked()) {
            ...
            editor.putInt("aciertoAlimento2", 1);
            editor.apply();
            ...
            button1.setEnabled(false);
            //Manda el dato al MainActivity
            editor.putInt("aciertoAlimento2", 0);
            editor.apply();
            // Llama al método para ir a la siguiente actividad después del retraso
            new Handler().postDelayed(this::P3, 2000);
    ...
    public void P3(){
        Intent p3 = new Intent(this, AlimentosP3.class);
        startActivity(p3);
    }
