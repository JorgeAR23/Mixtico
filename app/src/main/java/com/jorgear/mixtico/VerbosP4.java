...
public class VerbosP4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbos_p4);
    ...
    public void P5(){
        Intent p5 = new Intent(this, VerbosP5.class);
        startActivity(p5);
    }
