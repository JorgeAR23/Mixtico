...
public class VerbosP1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbos_p1);
    ...
    public void P2(){
        Intent p2 = new Intent(this, VerbosP2.class);
        startActivity(p2);
    }
